...
enum ColorList {
    ...
    static let trueButton = #colorLiteral(red: 0.09411764706, green: 0.4352941176, blue: 0.9490196078, alpha: 1)
    ...
    static let labelFalse = #colorLiteral(red: 0.9411764706, green: 0.2666666667, blue: 0.3215686275, alpha: 1)
